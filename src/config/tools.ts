...
// ─── Document Tools ───────────────────────────────────────────────────────────
export const documentTools: ToolConfig[] = [
  { id:"doc-html-to-pdf",      category:"document" as ToolCategory, slug:"/document/html-to-pdf",      title:"HTML to PDF – Free Online",              headline:"HTML to PDF Converter",        description:"Convert HTML to PDF online free using the browser print engine.",            longDescription:"",actionVerb:"convert HTML to PDF",    keywords:["html to pdf","convert html to pdf online","html pdf converter"],          inputFormats:[],outputFormat:"",outputExtension:"",maxFileSizeMB:0,maxBatchSize:1,searchVolume:800000, relatedTools:[],howToSteps:["Paste HTML.","Preview.","Print to PDF."],faqs:[] },
  { id:"doc-text-to-pdf",      category:"document" as ToolCategory, slug:"/document/text-to-pdf",      title:"Text to PDF – Convert Text to PDF Free",  headline:"Text to PDF Converter",        description:"Convert plain text to PDF with custom font size and margins.",               longDescription:"",actionVerb:"convert text to PDF",    keywords:["text to pdf","convert text to pdf online free","txt to pdf"],             inputFormats:[],outputFormat:"",outputExtension:"",maxFileSizeMB:0,maxBatchSize:1,searchVolume:500000, relatedTools:[],howToSteps:["Paste text.","Set font/margin.","Download PDF."],faqs:[] },
  { id:"doc-html-markdown",    category:"document" as ToolCategory, slug:"/document/html-markdown",    title:"HTML ↔ Markdown Converter – Free Online", headline:"HTML ↔ Markdown Converter",    description:"Convert HTML to Markdown or Markdown to HTML online free.",                  longDescription:"",actionVerb:"convert HTML/Markdown", keywords:["html to markdown","markdown to html","html markdown converter online"],    inputFormats:[],outputFormat:"",outputExtension:"",maxFileSizeMB:0,maxBatchSize:1,searchVolume:350000, relatedTools:[],howToSteps:["Choose mode.","Paste input.","Click Convert."],faqs:[] },
  { id:"doc-pdf-page-counter", category:"document" as ToolCategory, slug:"/document/pdf-page-counter", title:"PDF Page Counter – Count PDF Pages Free",  headline:"PDF Page Counter",             description:"Count pages in a PDF file online free. Also shows title and author.",        longDescription:"",actionVerb:"count PDF pages",        keywords:["pdf page counter","count pdf pages","how many pages in pdf"],              inputFormats:["application/pdf"],outputFormat:"",outputExtension:"",maxFileSizeMB:100,maxBatchSize:1,searchVolume:200000, relatedTools:[],howToSteps:["Drop PDF file.","See page count instantly."],faqs:[] },
  { id:"doc-docx-to-txt",      category:"document" as ToolCategory, slug:"/document/docx-to-txt",      title:"DOCX to TXT – Extract Text from Word",    headline:"DOCX to Text Extractor",       description:"Extract plain text from Word (.docx) documents online free.",                longDescription:"",actionVerb:"convert DOCX to TXT",   keywords:["docx to txt","word to text","extract text from docx online"],              inputFormats:[],outputFormat:"",outputExtension:"",maxFileSizeMB:20,maxBatchSize:1,searchVolume:250000, relatedTools:[],howToSteps:["Drop DOCX file.","See text extracted.","Download .txt."],faqs:[] },
  { id:"doc-image-flip-rotate",category:"document" as ToolCategory, slug:"/document/image-flip-rotate",title:"Image Flip & Rotate – Free Online Tool",  headline:"Image Flip & Rotate",          description:"Flip or rotate images online free. Horizontal/vertical flip, 90° rotation.", longDescription:"",actionVerb:"flip and rotate images", keywords:["image flip","rotate image online","flip image horizontal","flip image free"], inputFormats:["image/jpeg","image/png","image/webp"],outputFormat:"",outputExtension:"",maxFileSizeMB:50,maxBatchSize:1,searchVolume:400000, relatedTools:[],howToSteps:["Upload image.","Choose operation.","Apply and download."],faqs:[] },
];

export const allTools: ToolConfig[] = [...imageTools, ...pdfTools, ...textTools, ...unitTools, ...utilityTools, ...dataTools, ...codeTools, ...documentTools];

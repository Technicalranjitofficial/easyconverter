...
const categories = [
  ...
  },
  {
    icon: FileText,
    name: "PDF Tools",
    description: "Merge, split, compress, rotate and convert PDFs",
    href: "/pdf",
    count: 14,
    available: true,
  ...
  },
  {
    icon: Hash,
    name: "Text Tools",
    description: "Word counter, case converter, lorem ipsum, diff checker",
    href: "/text",
    count: 13,
    available: true,
  ...
  },
  {
    ...
    description: "Length, weight, temperature, speed and 11 more",
    href: "/unit",
    count: 15,
    available: true,
  ...
  },
  {
    icon: Star,
    name: "Utilities",
    description: "QR code, password, UUID, hash, BMI, EMI calculators",
    href: "/utilities",
    count: 14,
    available: true,
  ...
  },
  {
    icon: Users,
    name: "Data Tools",
    description: "JSON, CSV, XML, YAML, Excel and SQL converters",
    href: "/data",
    count: 14,
    available: true,
  ...
  },
  {
    ...
    description: "HTML/CSS/JS formatters, color converter, meta tags",
    href: "/code",
    count: 13,
    available: true,
  ...
  },
  {
    icon: Video,
    name: "Document Tools",
    description: "HTML to PDF, text to PDF, Markdown converter",
    href: "/document",
    count: 6,
    available: true,

...
export const metadata: Metadata = { title: "HTML ↔ Markdown Converter – Free Online | EasyConverter.io", description: "Convert HTML to Markdown or Markdown to HTML online free.", alternates: { canonical: "https://easyconverter.io/document/html-markdown" } };

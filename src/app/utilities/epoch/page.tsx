...
export const metadata: Metadata = { title: "Epoch Converter – Unix Timestamp to Date | EasyConverter.io", description: "Convert Unix timestamps to dates and vice versa.", alternates: { canonical: "https://easyconverter.io/utilities/epoch" } };

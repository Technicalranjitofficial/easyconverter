...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://easyconverter.io/text/markdown-preview" },
  openGraph: { title: "Markdown Preview – Live Markdown Editor Online Free", description: "Preview Markdown in real time online for free. No upload needed, runs in your browser.", url: "https://easyconverter.io/text/markdown-preview", siteName: "EasyConverter.io", type: "website" },
};

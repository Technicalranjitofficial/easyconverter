...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://easyconverter.io/text/readability-score" },
  openGraph: { title: "Readability Score Checker – Flesch-Kincaid Online Free", description: "Check the readability score of your text online free. Flesch-Kincaid grade level calculator.", url: "https://easyconverter.io/text/readability-score", siteName: "EasyConverter.io", type: "website" },
};

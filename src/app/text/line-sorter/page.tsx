...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://easyconverter.io/text/line-sorter" },
  openGraph: { title: "Line Sorter – Sort Lines Alphabetically Online Free", description: "Sort lines A-Z, Z-A, by length or shuffle. Free online line sorting tool. No upload needed.", url: "https://easyconverter.io/text/line-sorter", siteName: "EasyConverter.io", type: "website" },
};

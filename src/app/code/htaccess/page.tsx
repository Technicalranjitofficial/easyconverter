...
export const metadata: Metadata = { title: "Htaccess Generator – .htaccess Generator Free | EasyConverter.io", description: "Generate .htaccess rules: HTTPS redirect, www, caching, gzip.", alternates: { canonical: "https://easyconverter.io/code/htaccess" } };

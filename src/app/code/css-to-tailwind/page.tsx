...
export const metadata: Metadata = { title: "CSS to Tailwind Converter Online Free | EasyConverter.io", description: "Convert CSS to Tailwind CSS classes online free.", alternates: { canonical: "https://www.easyconverter.io/code/css-to-tailwind" } };
